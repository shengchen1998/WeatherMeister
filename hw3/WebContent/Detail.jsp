<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="java.util.ArrayList" import="classes.Weather"%>
<!DOCTYPE html>
<%
	int index = Integer.parseInt(request.getParameter("index"));
ArrayList<WeatherInfo> w = (ArrayList<WeatherInfo>)session.getAttribute("result");
WeatherInfo city = w.get(index);
%>
<html>
	<head>
		<meta charset="ISO-8859-1">
		<title><%=city.getCity()%></title>
		<script>
	...
	<body>
		...
		<div style="position:fixed;height:10%;">
			<font style="color:white;position:fixed;top:10%;font-size:50px;"><%=city.getCity()%></font>
		</div>
		<div id="buttons" style="position:fixed;top:20%;width:100%;height:80%;">
			<div id="location" style="text-align:center;width:25%;height:50%;float:left;">
				...
				<font style="color:white;font-size:30px;"><%=city.getState()%>,<br><%=city.getCountry()%></font>
				</button><br>
			...
			<div id="tempLow" style="text-align:center;width:25%;height:50%;float:left;">
				...
				<font style="color:white;font-size:30px;"><%=city.getDayLow()%></font>
				</button><br>
			...
			<div id="tempHigh" style="text-align:center;width:25%;height:50%;float:left;">
				...
				<font style="color:white;font-size:30px;"><%=city.getDayHigh()%></font>
				</button><br>
			...
			<div id="wind" style="text-align:center;width:25%;height:50%;float:left;">
				...
				<font style="color:white;font-size:30px;">Speed:<%=city.getWindspeed()%><br>Direction:<%=city.getWindDirection()%></font>
				</button><br>
			...
			<div id="humidity" style="text-align:center;width:25%;height:50%;float:left;">
				...
				<font style="color:white;font-size:30px;"><%=city.getHumidity()%></font>
				</button><br>
			...
			<div id="coordinate" style="text-align:center;width:25%;height:50%;float:left;">
				...
				<font style="color:white;font-size:30px;">Longitude:<%=city.getLongitude()%><br>Latitude:<%=city.getLatitude()%></font>
				</button><br>
			...
			<div id="currenttemp" style="text-align:center;width:25%;height:50%;float:left;">
				...
				<font style="color:white;font-size:30px;"><%=city.getCurrentTemperature()%></font>
				</button><br>
			...
			<div id="sun" style="text-align:center;width:25%;height:50%;float:left;">
				...
				<font style="color:white;font-size:30px;">Sunrise:<%=city.getSunrise()%><br>Sunset:<%=city.getSunset()%></font>
				</button><br>
